...
using ::envoy::extensions::filters::http::rate_limit_quota_apig::v3::RateLimitQuotaBucketSettings;
...
public:
  std::string name() const override { return "rate_limit_quota_apig"; }
  ...
  createActionFactoryCb(const Protobuf::Message& config, RateLimitOnMatchActionContext&,
    ...
    const auto bucket_settings =
        MessageUtil::downcastAndValidate<const envoy::extensions::filters::http::rate_limit_quota_apig::
