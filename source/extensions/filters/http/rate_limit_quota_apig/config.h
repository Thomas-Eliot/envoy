...
inline constexpr absl::string_view FilterName = "envoy.filters.http.rate_limit_quota_apig";

class RateLimitQuotaFilterFactory
    : public Common::FactoryBase<
          envoy::extensions::filters::http::rate_limit_quota_apig::v3::RateLimitQuotaFilterConfig,
          envoy::extensions::filters::http::rate_limit_quota_apig::v3::RateLimitQuotaOverride>,
